        ...
        fun getAll(): List<Game>{
            ...
            , listOf(UserRating("mossbag", 1, 5.0), UserReview("IndigoWendigo", 2, "Full of bugs. 10/10"), UserRating("GreySteel", 5, 4.0),
                UserReview("I_Am_Maty", 9, "It is ok no other game made me rage quit in the first 40 minutes." +
                        "But it is a actually good game."), UserReview("Aza", 6, "What can I say that has not already been said about this Overwhelmingly Positive experience. Just get the game already.")))
            , Game("Apex Legends", "PC/PlayStation/XBox/Nintendo Switch", "5.11.2020", 88.0, "apex_legends", "T", "Respawn Entertainment",
                ...
                UserRating("Aldin", 3, 4.5), UserReview("Beetle", 7, "Tap-strafe your way into certain death as 60% of this player base relying on a cheeky little feature called aim assist."))),
                Game("Elden Ring", "PC/PlayStation/XBox", "25.2.2022", 96.0, "elden_ring", "M+17",
                    ...
                    listOf()), Game("Dead Cells", "PC/PlayStation/XBox/Nintendo Switch", "6.8.2018", 89.0, "dead_cells",
                    ...
                    listOf()), Game("Red Dead Redemption 2", "PC/PlayStation/XBox", "5.12.2019", 97.0, "red_dead_2", "M17+",
                    ...
                    listOf()), Game("Marvel’s Spider-Man Remastered", "PlayStation/Pc", "12.8.2022", 87.0, "spider_man", "T",
                    ...
                    listOf()), Game("STAR WARS Jedi: Fallen Order", "PC/PlayStation/XBox", "15.11.2019", 79.0, "star_wars", "T",
                    ...
                    listOf()), Game("Portal 2", "PC", "19.4.2011", 95.0, "portal_2", "E+10",
                    ...
                    listOf()), Game("Dark Souls III", "PC/PlayStation/XBox", "11.4.2016", 89.0, "dark_souls_3", "M+17","FromSoftware Inc.",
                    ...
                    listOf()), Game("Forza Horizon 5", "XBox/Pc", "9.11.2021", 92.0, "forza_5", "E", "Playground Games",
